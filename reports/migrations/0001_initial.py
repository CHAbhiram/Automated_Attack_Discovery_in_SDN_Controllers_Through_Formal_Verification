    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('report_type', models.CharField(choices=[('vulnerability', 'Vulnerability Report'), ('simulation', 'Simulation Report'), ('full', 'Full Security Report'), ('network', 'Network Topology Report')], max_length=30)),
